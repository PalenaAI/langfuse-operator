...
// +kubebuilder:rbac:groups=langfuse.bitkaio.com,resources=langfuseprojects,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=langfuse.bitkaio.com,resources=langfuseprojects/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=langfuse.bitkaio.com,resources=langfuseprojects/finalizers,verbs=update
